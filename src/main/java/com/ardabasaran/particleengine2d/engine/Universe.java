...
public class Universe implements Runnable {
    ...
    public Universe(UniverseConfig config) {
        initFields(
                1.0 / config.getTicksPerSecond() / config.getUpdatesPerTick(),
                config.getWidth(),
                config.getHeight(),
                config.getUpdatesPerTick(),
                1000 / config.getTicksPerSecond(),
                config.getGravitationalAcceleration(),
                config.getDebug());
