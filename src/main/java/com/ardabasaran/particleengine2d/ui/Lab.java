...
public class Lab extends JComponent implements ActionListener {
    ...
    private static void addRandomParticles(
            Universe universe,
            int numParticles,
            double particleRadius,
            Map<Particle, Color> particleColors,
            Color color) {
    ...
    private static void addRectangleParticleGroup(
            Universe universe,
            double r,
            int startX,
            int startY,
    ...
    public static void main(String[] args) {
        ...
        addRectangleParticleGroup(universe, 20, 100, 1000, 5, 10, lab.particleColors, Color.BLUE);

        addRectangleParticleGroup(universe, 20, 900, 700, 10, 5, lab.particleColors, Color.RED);

        addRectangleParticleGroup(universe, 30, 1200, 300, 12, 2, lab.particleColors, Color.ORANGE);

        addRectangleParticleGroup(universe, 50, 100, 100, 1, 3, lab.particleColors, Color.GREEN);

        addRectangleParticleGroup(universe, 30, 100, 1500, 1, 20, lab.particleColors, Color.MAGENTA);

        addRandomParticles(
                universe,
                2 * config.getNumberOfRandomParticles() / 3,
