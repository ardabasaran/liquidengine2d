...
public class ParticlePair {
  ...
  public boolean equals(Object other) {
    ...
    boolean cond1 = this.first == otherParticlePair.first && this.second == otherParticlePair.second;
    boolean cond2 = this.first == otherParticlePair.second && this.second == otherParticlePair.first;
    return cond1 || cond2;
  }
}
