...
public class UniverseConfig {
    ...
    private CollisionDetectorType detectorType;
    private CollisionResolverType resolverType;
    ...
    private UniverseConfig(
            ...
            CollisionResolverType resolverType,
            String borderHandlerType,
    ...
    public CollisionDetectorType getDetectorType() {
        return detectorType;
    }

    public CollisionResolverType getResolverType() {
        return resolverType;
    }
    ...
    static UniverseConfig getDefaultConfig() {
        return new UniverseConfig(
                ...
                DEFAULT_BORDER_HANDLER_TYPE,
                DEFAULT_PARTICLE_GROUP_HANDLER_TYPE);
    }
    ...
    public String toString() {
        return "Universe Config:\n"
                ...
                + String.format("%.3f", gravitationalAcceleration)
                + "\n"
                + "\t\tCoefficient of restitution: "
                + String.format("%.3f", coefficientOfRestitution)
                + "\n"
                + "\t\tMinimum diameter: "
                + String.format("%.3f", minimumDiameter)
                + "\n"
                + "\t\tUpdates per frame: "
                + updatesPerTick
                + "\n"
                ...
                + borderHandlerType
                + "\n"
                + "\t\tParticle group handler type: "
                + particleGroupHandlerType
                + "\n";
    }
